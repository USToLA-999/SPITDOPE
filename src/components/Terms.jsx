            ...
            <div className="container mx-auto">
                <div className="innertermsbox mt-10">
                    <div className="headline text-center">
                        <h1 className='text-6xl  text-green-600 jersey-15-regular '><span className="span">Terms & Conditions </span></h1>
                    </div>
                </div>
                <div className="alltermsbox pt-5   mx-auto w-11/12 max-auto ">
                    ...
                    <div className="paraboxlinesbox mt-5 poppins-regular">
                        <p>Welcome to SpitDope. These Terms and Conditions (“Terms”, “Agreement”) set forth the legally binding terms for your use of our website www.spitdopeinc.in and services. By accessing or using this Site, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use the Site.</p>
                    </div>
                    <div className="aboutspitdopebox mt-5">
                        <div className="head jersey-15-regular text-2xl">
                            <h1>1. About SpitDope</h1>
                        </div>
                        <div className="paraliners poppins-regular">
                            <p>SpitDope is a creative community and platform dedicated to supporting emerging artists in the hip-hop scene. From time to time, we launch exclusive, limited-edition merchandise (“Merch”) to support our mission and culture.</p>
                        </div>
                    </div>

                    <div className="eligibilitybox mt-5">
                        <div className="head jersey-15-regular text-2xl">
                            <h1>2.Eligibility</h1>
                        </div>
                        <div className="paraliners poppins-regular">
                    ...
                    <div className="seasonalmech mt-5">
                        <div className="head jersey-15-regular text-2xl">
                            <h1>3. Seasonal Merchandise Sales</h1>
                        </div>
                        <div className="paraliners poppins-regular">
                            <ul className="mx-5">
                    ...
                    <div className="returnrefund mt-5">
                        <div className="head jersey-15-regular text-2xl">
                            <h1>6. Returns, Refunds & Exchanges</h1>
                        </div>
                        <div className="paraliners poppins-regular">
                            <ul className="mx-5">
                    ...
                    <div className="userconduct mt-5">
                        <div className="head jersey-15-regular text-2xl">
                    ...
                    <div className="privacy mt-5">
                        ...
                        <div className="paraliners poppins-regular">
                            <p>We respect your privacy. Please refer to our Privacy Policy for information about how we collect, use, and protect your data.</p>
                        </div>
                    </div>
                    <div className="warranties mt-5">
                        <div className="head jersey-15-regular text-2xl">
                    ...
                    <div className="termination mt-5">
                        <div className="head jersey-15-regular text-2xl">
                            <h1>12. Termination</h1>
                        </div>
                        <div className="paraliners poppins-regular">
                            <p>We may suspend or terminate access to the Site at any time, without notice, for any reason, including violation of these Terms.</p>

                        </div>
                    </div>
                    <div className="changes-term mt-5">
                        <div className="head jersey-15-regular text-2xl">
                            <h1>13. Changes to These Terms</h1>
                        </div>
                        <div className="paraliners poppins-regular">
                            <p>We may update these Terms occasionally. When we do, we’ll revise the “Last Updated” date at the top of this page. Continued use of the Site constitutes acceptance of any changes.</p>
                        </div>
                    </div>
                    <div className="governmanet-law mt-5">
                        <div className="head jersey-15-regular text-2xl">
                            <h1>14. Governing Law</h1>
                        </div>
                        <div className="paraliners poppins-regular">
                            <p>These Terms are governed by and construed in accordance with the laws of [Insert State/Country], without regard to its conflict of laws principles.</p>
                        </div>
                    </div>
                    <div className="connnectwithus mt-5">
                        <div className="head jersey-15-regular text-2xl">
                            <h1>15. Contact Us</h1>
                        </div>
                        <div className="paraliners poppins-regular">
                            <p>For questions about these Terms, or anything else, contact us at:</p>
